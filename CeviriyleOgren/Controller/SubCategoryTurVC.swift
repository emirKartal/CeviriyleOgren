//
//  SubCategoryTurVC.swift
//  CeviriyleOgren
//
//  Created by Emir Kartal on 18.12.2017.
//  Copyright © 2017 Emir Kartal. All rights reserved.
//

import UIKit

class SubCategoryTurVC: UIViewController,UITableViewDelegate,UITableViewDataSource {
